                    ...
                    <q-card flat bordered class="login-card">
                        <q-card-section class="q-pa-lg">
                            <div class="row items-center q-gutter-md q-mb-lg">
                                ...
                                <div>
                                    <div class="text-overline text-primary text-weight-medium">Área do usuário</div>
...
const login = () => {
    ...
    const authBuffer = btoa(`${dados.value.id}:${dados.value.ds_senha}`);

    api.post("/auth/loginUsuario", undefined, {
        headers: {
